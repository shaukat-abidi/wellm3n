...
int main (int argc, char* argv[])
{
  ...
  /*Read L from File*/
  read_L("/home/ssabidi/Shaukat/WellSSVM/implementation/mkl/WellSSVM/hmmsvm/params/L.txt",&model.L);
  ...
  read_mu("/home/ssabidi/Shaukat/WellSSVM/implementation/mkl/WellSSVM/hmmsvm/params/mu_converged.txt",&model,model.mu);
